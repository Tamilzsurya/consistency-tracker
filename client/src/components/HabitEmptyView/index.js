        ...
        <div className="habit-empty-view-bg-container">
            <div className="habit-empty-view">
                ...
                <section className="habit-empty-view-add-habit-section">
                    ...
                    <button className="habit-empty-view-add-habit-section-button"><FaPlus className="habit-empty-view-add-habit-section-button-icon" />Add Your First Habit</button>
                </section>
